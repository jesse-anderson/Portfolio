...
Geocoding follows a flag-don't-fix policy. Anything landing outside the village boundary, or carrying an unparseable date, year drift, or a missing field, raises a review flag. Silent correction would hide the records most worth checking. The published build reports its own gaps: 8 of 22,230 source rows dropped as unusable, 1,102 incidents (5.0 percent) that do not fall inside a mapped Oak Park zone, and 60 with no recoverable timestamp.
