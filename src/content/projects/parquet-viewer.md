...
Compression codecs are fetched lazily and cached, so a file that only needs Snappy never pays the download cost for zstd, gzip, and brotli. The file never leaves the browser.
